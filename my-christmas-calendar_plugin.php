...
class Mcac {
	...
	public function mcac_register_settings() {
		...
		add_settings_section('mcac_section', __('Advent Calendar', 'mcac'), array($this,'mcac_main_section_cb'), __FILE__);
		add_settings_field('mcac_subdomain',__('Web Address:  <span>http(s)://</span>  ','mcac'), array($this, 'mcac_subdomain_setting'), __FILE__, 'mcac_section');
	}
	...
	public function mcac_subdomain_setting() {
		echo "<input type='text' placeholder='subdomain.adventcalendar.com' class='mcac_subdomain' name='mcac_plugin_options[mcac_subdomain]' value='{$this->options['mcac_subdomain']}' />";
	}
...
?>
		<div class="mcac_wrap">
			<div class="mcac-help">
				...
				This option can be found in your Advent Calendar admin, under Settings > General > Web address.<br /><br />
				If this doesn\'t make sense to you, you\'ll probably need to register an account first.','mcac'); ?>
            </div>
<?php if(!empty($op['mcac_subdomain'])) { ?>
            <p class="mcac_account"><?php _e('<span>Haven\'t got an account?</span><br /><a target="_blank" class="button button-primary" href="https://adventcalendar.com/">Register here</a>', 'mcac') ?></p>
<?php }else{ ?>
			<p class="mcac_account mcac_animation_helper"><?php _e('<span>Haven\'t got an account?</span><br /><a target="_blank" class="button button-primary" href="https://adventcalendar.com/">Register here</a>', 'mcac') ?></p>
<?php }; ?>
            ...
            <?php
					...
					if(!empty($op['mcac_subdomain'])) {
						 ...
						 <span>[my_calendar width="100%" height="800px" border="3" bordercolor="000000"]</span>
						 ','mcac'); 
					?>
            ...
            <?php 
						...
						This option can be found in your Advent Calendar admin, under Settings > General > Web address','mcac'); 
            		}
			?>
            			</p>
					</div>
            ...
            <div class="mcac_disclaimer">
            	<p><?php _e('Brought to you by <a target="_blank" href="https://adventcalendar.com">Adventcalendar.com','mcac'); ?></a></p>
            </div>
